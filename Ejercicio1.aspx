...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <h2>Productos</h2>
            <asp:GridView ID="gvProductos" runat="server" AllowPaging="True" AutoGenerateColumns="False" 
                OnPageIndexChanging="gvProductos_PageIndexChanging" AutoGenerateDeleteButton="True" 
                AutoGenerateEditButton="true" OnRowDeleting="gvProductos_RowDeleting" BackColor="White" 
                BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" 
                OnRowEditing="gvProductos_RowEditing" OnRowCancelingEdit="gvProductos_RowCancelingEdit" 
                OnRowUpdating="gvProductos_RowUpdating" Width="600px" HorizontalAlign="Left">
